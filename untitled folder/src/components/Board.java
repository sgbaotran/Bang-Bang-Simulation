...
public class Board extends JPanel implements ActionListener {
	 ...
	 */
	public Board(int dimension, Color[] colors) {
	...
	public void addCoordinateButton(int row, int col, int buttonSize) {
		Coordinate button = new Coordinate(row, col);
...
//		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		button.setText(ALPHABET[button.getColumn()] + "" + (button.getRow()));
		button.setBackground(new Color(62,3,0));
