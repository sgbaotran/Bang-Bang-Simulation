...
public class StartMenu extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == singleButton) {
			...
			System.out.println("Bang Bang Simulations (バンバンシミュレーションズ, Ban Ban Shimyurēshonzu) is a naval warfare simulation video game and a updated version of Bang Bang Shooting created by Kuroto Dan. It is one of the games serving as the basis for the Gashat Gear Dual β alongside Taddle Fantasy. As the most powerful Gashat of Taiga Hanaya/Kamen Rider Snipe, it is by this name that Masamune Dan addresses him.");
		} else {
			audioOn = !audioOn;
			if (audioOn) {
				clip.stop();
